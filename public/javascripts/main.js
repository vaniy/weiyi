;$(function(){
	...
	$(".flow-s").hover(function(){
		var tit = $(this).text();
		var i = $(this).data('id');
		var arr = ['项目需求前期的沟通整理在整个项目开发过程中起着关键作用，此阶段将和客户充分沟通，从我们专业角度给到客户建议，避免后期走弯路。','从产品到设计，设计的效果会实时反馈客户，开发过程中会阶段性给到客户验收，避免最后结果和需求有差异。','开发完成后我们内部会做全面测试，然后给到客户测试，客户测试的问题我们会第一时间做好沟通和问题解决。','项目测试完毕后，我们会撰写必要的文档，给到客户做备案。','客户项目验收完毕后，付清尾款，期待后续继续合作。'];
